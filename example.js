...
var FasterExample = (function (_Component) {
  ...
  function FasterExample() {
    ...
    _get(Object.getPrototypeOf(FasterExample.prototype), 'constructor', this).call(this);
    this.state = {
      isFlipped: false
    };
    this.handleClick = this.handleClick.bind(this);
...
var SlowerExample = (function (_Component) {
  ...
  function SlowerExample() {
    ...
    _get(Object.getPrototypeOf(SlowerExample.prototype), 'constructor', this).call(this);
    this.state = {
      isFlipped: false
    };
    this.handleClick = this.handleClick.bind(this);
...
var _ExampleJsx = require('./Example.jsx');

var _ExampleJsx2 = _interopRequireDefault(_ExampleJsx);

var _SlowerExampleJsx = require('./SlowerExample.jsx');

var _SlowerExampleJsx2 = _interopRequireDefault(_SlowerExampleJsx);
...
var App = function App() {
	...
	return _react2['default'].createElement(
		...
		_react2['default'].createElement(
			...
			_react2['default'].createElement(_ExampleJsx2['default'], { styles: styles })
		),
		_react2['default'].createElement(
			'section',
			{ className: 'example-section' },
			...
			_react2['default'].createElement(_SlowerExampleJsx2['default'], { styles: styles })
		),
		_react2['default'].createElement(
			'section',
			{ className: 'example-section' },
